...
// Get user's appointments with health staff information
$appointments = [];
try {
    $stmt = $conn->prepare("
        SELECT a.*, hs.username as health_staff_username, hs.full_name as health_staff_name
        FROM appointments a 
        LEFT JOIN users hs ON a.confirmed_by = hs.id
        WHERE a.user_id = ? 
...
<head>
    ...
    <title>My Appointments - Resident Dashboard</title>
...
<body class="font-poppins bg-gray-50">
    ...
    <div class="flex">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="applications.php" class="flex items-center px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                        ...
                        My Applications
                                         ...
                                         <a href="appointments.php" class="flex items-center px-4 py-2 text-gray-700 bg-barangay-orange bg-opacity-10 rounded-lg border-l-4 border-barangay-orange">
                         <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 p-8 lg:ml-0 ml-0">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 font-eb-garamond">My Appointments</h1>
                <p class="text-gray-600">Manage your scheduled appointments with barangay services</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">View your scheduled appointments and their status</p>
                </div>
                ...
                <?php if (empty($appointments)): ?>
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-eb-garamond font-medium text-gray-900 mb-2">No Appointments Yet</h3>
                        <p class="text-gray-500">You haven't made any appointment requests yet. Visit the Services page to request an appointment.</p>
                        <div class="mt-4">
                            <a href="services.php" class="inline-flex items-center px-4 py-2 bg-barangay-green text-white rounded-lg hover:bg-green-700 transition-colors">
                                ...
                                <?php foreach ($appointments as $appointment): ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">Health Center</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if ($appointment['status'] === 'confirmed' && $appointment['health_staff_username']): ?>
                                                <div class="text-sm text-gray-900">
                                                    <span class="font-medium">Scheduled by:</span> 
                                                    <?php echo htmlspecialchars($appointment['health_staff_username']); ?>
                                                </div>
                                                <?php if ($appointment['health_staff_name']): ?>
                                                    <div class="text-sm text-gray-500">
                                                        <?php echo htmlspecialchars($appointment['health_staff_name']); ?>
                                                    </div>
                                                <?php endif; ?>
                                            <?php else: ?>
