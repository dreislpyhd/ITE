...
class Database {
    ...
    private function createTables() {
        ...
        // Add purpose column if it doesn't exist (for existing databases)
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN purpose TEXT");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        
        // Add requirements_files column if it doesn't exist (for existing databases)
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN requirements_files TEXT");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        ...
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        ...
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        ...
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN remarks TEXT");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        ...
        try {
            $this->connection->exec("ALTER TABLE applications ADD COLUMN notes TEXT");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        
        // Add password_changed column to users table if it doesn't exist
        try {
            $this->connection->exec("ALTER TABLE users ADD COLUMN password_changed BOOLEAN DEFAULT FALSE");
        } catch (PDOException $e) {
            // Column already exists, ignore error
        }
        ...
        // DISABLED: Auto-creation of barangay staff to allow deletion
        /*
        try {
        ...
        */
        ...
        // DISABLED: Auto-creation of default residents to allow deletion
        // Uncomment below if you need to recreate default test users
        /*
        try {
