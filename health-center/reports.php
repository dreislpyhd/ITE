        ...
        <div class="flex-1 p-8">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="text-center py-20">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 font-eb-garamond">Reports Module Under Development</h2>
                    <p class="text-gray-600 mb-6 max-w-md mx-auto">
                        We're working hard to bring you comprehensive health center reports and analytics. 
                        This feature will be available soon with detailed statistics, charts, and export capabilities.
                    </p>
