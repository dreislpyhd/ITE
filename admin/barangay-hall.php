                ...
                <?php if (empty($services)): ?>
                    <div class="col-span-full bg-white rounded-xl shadow-md p-12">
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <p class="text-gray-500">There are currently no barangay services to display.</p>
                        </div>
                    </div>
                <?php else: ?>
                            ...
                            <div class="p-6">
                                ...
                                <?php if ($service['requirements']): ?>
                                    <div class="mb-3">
                                        ...
                                        <p class="text-xs text-gray-600"><?php echo htmlspecialchars($service['requirements']); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
